          ...
          <div className="row no-gutters">
            ...
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Orders to be prepared for pick-up</h5>
                <p className="card-text">
                  • View &#38; prepare orders for pick-up<br />
                  • Confirm order preparation<br />
                </p>
                <div className="d-block text-end">
                  <Link to="/warehouse-prepare">
                    <button className="btn" style={{ backgroundColor: "#A6896F", color: "black" }}>Prepare orders</button>
                  </Link>
                </div>
              </div>
            </div>
