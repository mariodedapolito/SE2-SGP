...
function ManagerArea(props) {
  ...
  return (
    <div className="row w-100">
     ...
     <div className="card m-3 d-block shadow">
          <div className="row no-gutters">
            <div className="col-md-4 p-3 text-center" style={{ backgroundColor: "#f5f5dc" }}>
              {walletIcon}
            </div>
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  •Mark as missed an unpicked up order<br />
                  
                </p>
                <div className="d-block text-end">
                  <Link to="/see-pickups">
                    <button className="btn" style={{ backgroundColor: "#f5f5dc", color: "black" }}>See past pickups </button>
                  </Link>
                </div>
              </div>
            </div>
