...
import { Form, OverlayTrigger, Popover, Navbar, Container, Nav, NavDropdown, Button } from 'react-bootstrap'
...
const cartIcon = <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-cart3" viewBox="0 0 16 16">
