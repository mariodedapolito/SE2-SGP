            ...
            <ul className="list-group list-group-flush">
              <li className="list-group-item d-flex justify-content-between">
                  ...
                  <Carousel variant="dark">
                    <Carousel.Item interval={10000}>
                      ...
                      <Carousel.Caption className="carousel-custom-background">
                        ...
                        <p>
                          In our store you will find only the freshest and the
                          best produce. All from local farms and producers.
                        </p>
                      </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={10000}>
                      ...
                      <Carousel.Caption className="carousel-custom-background">
                        ...
                        <p>
                          More than 50 farmers work tirelessly to deliver only
                          the best produce to your dish.
                        </p>
                      </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={10000}>
                      ...
                      <Carousel.Caption className="carousel-custom-background">
                        ...
                        <p>
                          With a dedicated team of delivery workers, the local
                          fresh produce has never been closer to your home.
                        </p>
                      </Carousel.Caption>
                    </Carousel.Item>
                  </Carousel>
                  ...
                  <div className="row">
                    <div className="col-md-8">
                      ...
                      <p className="d-block text-justify-custom">
                        With more than 250 products weekly we ensure that you
                        will find everything you need to prepare all your
                        healthy dishes. We check and handpick each product one
                        by one to make sure that on your table you will put only
                    ...
                    <div className="col-md-4 text-center">
                      <img
                        ...
                        src={
                          ...
                          'Frontpage/browse-products-image.png'
                        }
                        alt="Product"
                      />
                    </div>
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(to bottom, #A69C98 90%, #D98C5F)',
                  }}
                >
                  <div className="row">
                    <div className="col-lg-4 text-center">
                      <img
                        ...
                        src={
                          process.env.PUBLIC_URL +
                          'Frontpage/browse-farmers-image.png'
                        }
                        alt="Product"
                      />
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-8">
                      ...
                      <div className="d-block w-100 mt-5 text-center align-bottom-custom">
                        <Button variant="secondary mb-3 me-3">
                          Apply as farmer
                        </Button>
