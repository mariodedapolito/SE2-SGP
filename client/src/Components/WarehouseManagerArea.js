            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  • View pick-up orders schedule<br />
                  • View pick-up orders preparation status<br />
                  • View pick-up orders that have not yet been picked up by the clients<br />
                </p>
                <div className="d-block text-end">
                  <Link to="/warehouse-orders">
                    <button className="btn" style={{ backgroundColor: "#A6896F", color: "black" }}>View orders</button>
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="row no-gutters">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  • View &#38; incoming farmer shipments<br />
                  • Confirm receipt of farmer shipment<br />
                </p>
                <div className="d-block text-end">
                  <Link to="/warehouse-shipments">
                    <button className="btn" style={{ backgroundColor: "#D9C9BA", color: "black" }}>Manage farmer shipments</button>
                  </Link>
                </div>
              </div>
            </div>
